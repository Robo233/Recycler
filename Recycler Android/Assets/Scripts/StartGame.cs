...
public class StartGame : MonoBehaviour
{
     ...
     public void StartGameInfinitEasy(){
        ...
        if(PlayerPrefs.GetInt("isFirstTimePlayingInfinitEasy") == 0){
            ...
            PlayerPrefs.SetInt("isFirstTimePlayingInfinitEasy",1);
             ...
             StartGameFunction(0, "InfinitEasy", new List<string> (new string[] { "Metal", "Plastic", "Paper", "Organic", "Glass", "E-Waste" } ), new Vector2[] { new Vector2(-330,275), new Vector2(-330,0), new Vector2(-330,-275), new Vector2(230,275), new Vector2(230,0), new Vector2(230,-275) } , 3, 2, 0.0009f, -0.0002f, 0 );
   ...
   public void StartGameInfinitReserve(){
       Debug.Log("asdasd");
       StartGameFunction(0, "Infinit", new List<string> (new string[] { "Metal", "Plastic", "Paper", "Organic", "Glass", "E-Waste" } ), new Vector2[] { new Vector2(-330,275), new Vector2(-330,0), new Vector2(-330,-275), new Vector2(230,275), new Vector2(230,0), new Vector2(230,-275) } , 3, 2, 0.0009f, -0.0002f, 0 );
    }
    ...
    public void StartGameInfinitMedium(){
      ...
      public void StartGameInfinitHard(){
           ...
           if(PlayerPrefs.GetInt("isFirstTimePlayingInfinitHard") == 0){
            ...
            StartGameFunction(0, "InfinitHard", new List<string> (new string[] { "Metal", "Plastic", "Paper", "Organic", "Glass", "E-Waste" } ), new Vector2[] { new Vector2(-330,275), new Vector2(-330,0), new Vector2(-330,-275), new Vector2(230,275), new Vector2(230,0), new Vector2(230,-275) } , 3, 2, 0.0006f, -0.0003f, 0 );
